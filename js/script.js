...
const translations = {
    ar: {
        ...
        loginLink: "تسجيل الدخول", copyrightText: `© ${new Date().getFullYear()} Rania Hamouda. جميع الحقوق محفوظة.`,
    ...
    en: {
        ...
        copyrightText: `© ${new Date().getFullYear()} Rania Hamouda. All rights reserved.`,
